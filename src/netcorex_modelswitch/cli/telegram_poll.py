...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--use-state", action="store_true", help="Read and persist offset state automatically")
    return parser
...
def main() -> None:
    ...
    if args.use_state:
        next_offset = runtime.poll_once_with_state(timeout=args.timeout)
    else:
